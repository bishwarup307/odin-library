...
const bookGenreFormSelect = document.querySelector("#book_genre");
...
addBookBtn.addEventListener("click", () => {
  ...
  bookGenreFormSelect.appendChild(options);
...
addToLibraryBtn.addEventListener("click", (event) => {
  ...
  if (validateForm()) {
    ...
    } else imageUrl = "./assets/images/no-cover.jpg";
